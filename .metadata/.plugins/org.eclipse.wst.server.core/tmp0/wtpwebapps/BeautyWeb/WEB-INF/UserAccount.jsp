                    ...
                    <div class="aa-product-catg-head">
                        <div class="aa-product-catg-head-left">
                            <form action="" class="aa-sort-form">
                                ...
                                <select name="">
                                    <option value="1" selected="Default"><fmt:message key="Default" bundle="${BundleContent}"/></option>
                                    <option value="2"><fmt:message key="Support" bundle="${BundleContent}"/> | <fmt:message key="If you have any question" bundle="${BundleContent}"/></option>
                                    <option value="3"><fmt:message key="Orders" bundle="${BundleContent}"/> | <fmt:message key="If you have problem with your order" bundle="${BundleContent}"/></option>
                ...
                <aside class="aa-sidebar">
                    ...
                    <div class="aa-sidebar-widget">
                        ...
                        <h3><fmt:message key="Users Section" bundle="${BundleContent}"/>
                         ...
                         <button class="accordion"><fmt:message key="Profile" bundle="${BundleContent}"/> <i class="fa fa-user"></i></button>

                        <div class="panel">
                            <ul class="aa-catg-nav">
                                <li><a href="#"><fmt:message key="Update Profile" bundle="${BundleContent}" /> <i class="fa fa-wrench"></i></a></li>
                            <li><a href=""><fmt:message key="Change password" bundle="${BundleContent}" /> <i class="fa fa-unlock-alt"></i></a></li>
                            <li><a href=""><fmt:message key="Add Picture" bundle="${BundleContent}" /> <i class="fa fa-image"></i></a></li>
                            </ul>
                        </div>


                        <button class="accordion"><fmt:message key="Verifications" bundle="${BundleContent}"/> <i class="fa fa-book"></i></button>
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                <li><a href="#"><fmt:message key="Email verification" bundle="${BundleContent}" /> <i class="fa fa-check-circle"></i></a></li>
                                <li><a href=""><fmt:message key="Phone verification" bundle="${BundleContent}" /> <i class="fa fa-circle-o"></i></a></li>
                                <li><a href=""><fmt:message key="Address verification" bundle="${BundleContent}" /> <i class="fa fa-circle-o"></i></a></li>
                            </ul> </div>

                        <button class="accordion"><fmt:message key="Orders" bundle="${BundleContent}"/> <i class="fa fa-product-hunt" aria-hidden="true"></i></button>
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                <li><a href="#"><fmt:message key="New Orders" bundle="${BundleContent}" /> <i class="fa fa fa-plus-circle"></i></a></li>
                                <li><a href=""><fmt:message key="Shipped Orders" bundle="${BundleContent}" /> <i class="fa fa fa-truck"></i></a></li>
                                <li><a href=""><fmt:message key="Received orders" bundle="${BundleContent}" /> <i class="fa fa-archive"></i></a></li>
                                <li><a href=""><fmt:message key="History" bundle="${BundleContent}" /> <i class="fa fa-history"></i></a></li>
                                <li><a href=""><fmt:message key="Returned" bundle="${BundleContent}" /> <i class="fa fa-exchange"></i></a></li>
                                <li><a href=""><fmt:message key="Invoice" bundle="${BundleContent}" /> <i class="fa fa-file-text"></i></a></li>
                            </ul>
                        </div>

                        <button class="accordion"><fmt:message key="Favorites" bundle="${BundleContent}"/> <i class="fa fa-heartbeat"></i></button>
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                <li><a href="#"><fmt:message key="Wish list"  bundle="${BundleContent}" /> <i class="fa fa-heart"></i></a></li>
                                <li><a href="#"> <fmt:message key="Products" bundle="${BundleContent}" /> <i class="fa fa-anchor"></i></a></li>
                                <li><a href="#"><fmt:message key="Sellers" bundle="${BundleContent}" /> <i class="fa fa-diamond"></i></a></li>


                            </ul>
                        </div>

                        <button class="accordion"><fmt:message key="Mailbox" bundle="${BundleContent}"/> <i class="fa fa-envelope"></i>

                        </button>
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                <li><a href="ReadUserEmail?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message key="Inbox" bundle="${BundleContent}" />  <i class="fa fa-envelope"></i>
                                      <span class="pull-right-container">
                                <span class="label label-primary pull-right"><%=request.getAttribute("CountMessages")%>
                                </span>
                                </a>
                                </li>
                                <li><a href="Compose?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message key="Compose" bundle="${BundleContent}"/><i class="fa fa-send-o"></i></a></li>
                                <li><a href="#"><fmt:message key="Contacts Book" bundle="${BundleContent}" /> <i class="fa fa-book"></i></a></li>

                            </ul>
                        </div>

                        <button class="accordion"><fmt:message key="Gift cards" bundle="${BundleContent}"/> <i class="fa fa-gift"></i> </button>
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                <li><a href="#"><fmt:message key="Gift cards" bundle="${BundleContent}" /> <i class="fa fa-gift"></i></a></li>
                                <li><a href="#"><fmt:message key="Gift cards" bundle="${BundleContent}" /> <i class="fa fa-gift"></i></a></li>
                                <li><a href="#"><fmt:message key="Gift cards" bundle="${BundleContent}" /> <i class="fa fa-gift"></i></a></li>
                                <li><a href="#"><fmt:message key="Gift cards" bundle="${BundleContent}" /> <i class="fa fa-gift"></i></a></li>
                        ...
                        <button class="accordion"><fmt:message key="Become seller" bundle="${BundleContent}"/> <i class="fa fa-signal"></i></button>
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                <li><a href="#"><fmt:message key="Become seller" bundle="${BundleContent}" /> <i class="fa fa-signal"></i></a></li>
                            </ul>
                        </div>
