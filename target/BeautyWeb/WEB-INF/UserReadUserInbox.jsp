                                    ...
                                    <div class="mailbox-controls with-border text-center">
                                        <div class="btn-group">
                                            ...
                                            <c:if test="${requestScope.mesageById != null}">
                                                <c:forEach items="${requestScope.mesageById}" var="readEmail"
                                                           varStatus="page">
                                        ...
                                        <!-- /.btn-group -->
                                        <button type="button" onclick="printContent('print')"
                                                class="btn btn-default btn-sm" data-toggle="tooltip" title="Print">
                                    ...
                                    <c:if test="${requestScope.mesageById != null}">
                                        <c:forEach items="${requestScope.mesageById}" var="readEmail" varStatus="page">
                                            <div class="box-body no-padding" id="print">
                                                <div class="mailbox-read-info">
                                                    ...
                                                    <h5>From: <c:out value="${readEmail.messageFrom}"/>
                                                        ...
                                                        <span class="mailbox-read-time pull-right"><c:out
                                                                value="${readEmail.messageDate}"/></span></h5>
                                                </div>
                                                <!-- /.mailbox-read-info -->
                                            ...
                                            <div class="box-footer">
                                                ...
                                                <a type="button" onclick="printContent('print')"
                                                   class="btn btn-default btn-sm" data-toggle="tooltip" title="Print">
