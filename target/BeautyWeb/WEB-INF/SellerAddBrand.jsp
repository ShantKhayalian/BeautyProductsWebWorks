...
<section id="aa-catg-head-banner">
    <img src="<%=request.getContextPath()%>/img/advertisinginuserpage/Celebrate-Web-banner-top-1920x300.jpg"
         alt="Advertising img">
                        ...
                        <div class="aa-product-catg-head-left">
                            ...
                            <%-- <form action="" class="aa-sort-form">
                                 ...
                                 <select  name="sectionid" class="InputWidth" onchange="window.location.href = sectionid.options[selectedIndex].value">
                                     ...
                                     <option value="SendEmailToAdmin?To=Support"><fmt:message key="Support" bundle="${BundleContent}"/> |
                                         <fmt:message key="If you have any question" bundle="${BundleContent}"/></option>
                                     <option value="SendEmailToAdmin?To=Orders"><fmt:message key="Orders" bundle="${BundleContent}"/> |
                    ...
                    <div class="aa-product-catg-body">
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <!--UserWebId int(11)
                               -->
                                <form action="SellerAddNewBrand" method="get">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <c:if test="${requestScope.brandsList != null}">
                                                <c:forEach items="${requestScope.brandsList}" var="BrandList"
                                                           varStatus="Page">
                                                    <label for="exampleInputFirstName">Brand Name</label>
                                                    <c:set var="ON" value="${BrandList.brandName}"/>
                                                    <c:choose>
                                                    <c:when test="${ON != 'null'}">
                                                    <input name="BrandName" type="text" class="form-control"
                                                           id="exampleInputFirstName"
                                                           placeholder="Enter your Brand Name"
                                                           value="${BrandList.brandName}" required>
                                                        <small>please be careful with the brand naming, you cant change it after submission.</small>
                                                    </c:when>
                                                    <c:otherwise>
                                                    <input name="BrandName" type="text" class="form-control"
                                                           id="exampleInputFirstName"
...
<br/>
                                                    ...
                                                    <c:set var="ON" value="${BrandList.brandCategory}"/>
                                                    <c:choose>
                                                    <c:when test="${ON != 'null'}">
                                                <select name="BrandCategory" class="form-control select2"
                                                        style="width: 100%;" required>
                                                    <option value="${BrandList.brandCategory}"
                                                            selected="selected">${BrandList.brandCategory}</option>
                                                    ...
                                                    <c:set var="ON" value="${BrandList.brandKind}"/>
                                                    <c:choose>
                                                    <c:when test="${ON != 'null'}">
                                                    <select name="BrandType" class="form-control select2"
                                                            style="width: 100%;" required>
                                                        <option value="${BrandList.brandKind}"
                                                                selected="selected">${BrandList.brandKind}</option>
                                                        <option value="Home Made Business">Home Made Business</option>
                                                        ...
                                                        <option value="Non Above">Non Above </option>
                                                    </select>
                                                    </c:when>
                                                    <c:otherwise>
                                                <select name="BrandType" class="form-control select2"
                                                    ...
                                                    <br/>
                                                    <label for="exampleInputAddress1">Brand Address one</label>
                                                        <c:set var="ON" value="${BrandList.brandAddress1}"/>
                                                        <c:choose>
                                                        <c:when test="${ON != 'null'}">
                                                    <input name="BrandAddress1" type="text" class="form-control"
                                                           id="exampleInputAddress1"
                                                           placeholder="Enter your Brand Address"
                                                           value="${BrandList.brandAddress1}" required>
                                                    </c:when>
                                                        <c:otherwise>
                                                    <input name="BrandAddress1" type="text" class="form-control"
                                                           id="exampleInputAddress1"
                                                    ...
                                                    <br/>
                                                    <label for="exampleInputAddress2">Brand Address two</label>
                                                        <c:set var="ON" value="${BrandList.brandAddress2}"/>
                                                        <c:choose>
                                                        <c:when test="${ON != 'null'}">
                                                    <input name="BrandAddress2" type="text" class="form-control"
                                                           id="exampleInputAddress2"
                                                           placeholder="Enter your Brand Address"
                                                           value="${BrandList.brandAddress2}">
                                                    </c:when>
                                                        <c:otherwise>
                                                    <input name="BrandAddress2" type="text" class="form-control"
                                                           id="exampleInputAddress2"
                                                    ...
                                                    <br/>
                                                    <label>Country</label>
                                                        <c:set var="ON" value="${BrandList.brandCountry}"/>
                                                        <c:choose>
                                                        <c:when test="${ON != 'null'}">
                                                    <select name="BrandCountry" class="form-control select2"
                                                            style="width: 100%;" required>
                                                        <option value="${BrandList.brandCountry}"
                                                                selected="selected">${BrandList.brandCountry}</option>
                                                    ...
                                                    <br/>
                                                    <label for="exampleInputCity">Brand City</label>
                                                        <c:set var="ON" value="${BrandList.brandCountry}"/>
                                                        <c:choose>
                                                        <c:when test="${ON != 'null'}">
                                                    <input name="BrandCity" type="text" class="form-control"
                                                           id="exampleInputCity"
                                                           placeholder="Brand City" required value="${BrandList.brandCity}">
                                                    </c:when>
                                                        <c:otherwise>
                                                    <input name="BrandCity" type="text" class="form-control"
                                                           id="exampleInputCity"
                                                           placeholder="Brand City" required >
                                                    </c:otherwise>
                                                    </c:choose>
                                                    <br/>


                                                    <label for="exampleInputZip">Brand ZipCode</label>
                                                        <c:set var="ON" value="${BrandList.brandCountry}"/>
                                                        <c:choose>
                                                        <c:when test="${ON != 'null'}">
                                                    <input name="BrandZipCode" type="text" class="form-control"
                                                           id="exampleInputZip"
                                                           placeholder="Brand ZipCode" required value="${BrandList.brandZipCode}">
                                                    </c:when>
                                                        <c:otherwise>
                                                    <input name="BrandZipCode" type="text" class="form-control"
                                                           id="exampleInputZip"
                                                           placeholder="Brand ZipCode" required >
                                                    </c:otherwise>
                                                    </c:choose>
                                                    <br/>

                                                    <label for="exampleInputState">Brand State</label>
                                                        <c:set var="ON" value="${BrandList.brandState}"/>
                                                        <c:choose>
                                                        <c:when test="${ON != 'null'}">
                                                    <input name="BrandState" type="text" class="form-control"
                                                           id="exampleInputState"
                                                           placeholder="Brand State" required value="${BrandList.brandState}">
                                                    </c:when>
                                                        <c:otherwise>
                                                    <input name="BrandState" type="text" class="form-control"
                                                           id="exampleInputState"
                                                           placeholder="Brand State" required >
                                                    </c:otherwise>
                                                    </c:choose>
                                                    <br/>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <c:set var="ON" value="${BrandList.brandPhoneNumber}"/>
                                                        <c:choose>
                                                        <c:when test="${ON != 'null'}">
                                                        <input name="BrandPhoneNumber" type="number"
                                                               class="form-control"
                                                               data-inputmask='"mask": "(999) 999-9999"' data-mask
                                                               required value="${BrandList.brandPhoneNumber}"placeholder="+374 98 22 98 98">
                                                        </c:when>
                                                        <c:otherwise>
                                                        <input name="BrandPhoneNumber" type="number"
                                                               class="form-control"
                                                               data-inputmask='"mask": "(999) 999-9999"' data-mask
                                                               required placeholder="+374 98 22 98 98">
                                                        </c:otherwise>
                                                        </c:choose>
                                                    </div>
                                                </c:forEach>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="PageCurrency"
                                                   value="<%= request.getAttribute("PageCurrency")%>">
                    ...
                    <div class="aa-product-catg-pagination">
                        ...
                        <h4>Important!</h4>
                        Every account must have one brand, for more branding creat another account.
                    ...
                    <div class="aa-sidebar-widget">
                        ...
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                <li>
                                    <a href="UserUpdateUserProfile?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message
                                            key="Update Profile" bundle="${BundleContent}"/> <i
                                            class="fa fa-wrench"></i></a></li>
                                <li>
                                    <a href="UserChangePassword?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message
                                            key="Change password" bundle="${BundleContent}"/> <i
                                            class="fa fa-unlock-alt"></i></a></li>

                                <i class="fa fa-unlock-alt"></i></a></li>


                                    <a href="SignOut?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message
                                            key="Sign out" bundle="${BundleContent}"/> <i
                            ...
                            <ul class="aa-catg-nav">
                               ...
                               <%-- <li>
                                    <a href="Compose?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>">
                                        <fmt:message key="Compose" bundle="${BundleContent}"/><i
                                            class="fa fa-send-o"></i></a>
                                </li>--%>
                                <li>
                                    <a href="AddressBook?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message
                                            key="Contacts Book" bundle="${BundleContent}"/> <i
