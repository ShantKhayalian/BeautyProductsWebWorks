                                            ...
                                            <table class="table table-hover table-striped">
                                                ...
                                                <c:if test="${requestScope.emailMessages != null}">
                                                    <c:forEach items="${requestScope.emailMessages}" var="NewsInBox" varStatus="loop">
                                                        <tr>
                                                            <td>
                                                                <input type="checkbox" name="chkSingle" value="${NewsInBox.messageID}"/></td>
                                                                 <script type="text/javascript">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${IMPORTANT == 'true'}">
                                                                    <td class="mailbox-star" >
                                                                        <a onClick="window.location='ReadUserEmail?value=notImportant&EmailId=${NewsInBox.messageID}&Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>'"   >
                                                                            <i class="fa fa-star text-yellow"></i></a></td>

                                                                </c:when>
                                                                <c:otherwise>
                                                                    <td class="mailbox-star">
                                                                        <a onClick="window.location='ReadUserEmail?value=Important&EmailId=${NewsInBox.messageID}&Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>'"   >
                                                                            <i class="fa fa-star-o text-yellow"></i></a></td>
                                                                </c:otherwise>
                                                            </c:choose>

                                                            <c:set var="IsRead" value="${NewsInBox.messageRead}" />
                                                            <c:choose>
                                                                <c:when test="${IsRead == 'true'}">
                                                                    <td class="mailbox-star" >
                                                                ...
                                                                <c:otherwise>
                                                                    <td class="mailbox-star">
                                                                            ...
                                                                            <i class="fa fa-check-circle-o"></i></td>
                                                                </c:otherwise>
                                                            </c:choose>


                                                            <td class="mailbox-name"><c:out value="${NewsInBox.messageFrom}"/></td>
                                                            <td class="mailbox-subject"><b></b> <a href="<%=request.getContextPath()%>/ReadMail?EmailId=${NewsInBox.messageID}&Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>">${NewsInBox.messageTitle}</a>
                                                            </td>
