                ...
                <div class="aa-product-catg-content">
                    ...
                    <div class="aa-product-catg-body">
                            ...
                            <div class="box box-primary">
                                ...
                                %>
                                <!-- /.box-header -->
                                <form action="SendUserEmail" method="post">
                                    <div class="box-body">
                                        <div class="form-group" >
                                            <p> <%=request.getParameter("MessageTo")%></p>
                                            <input type="hidden" name="emailTo" class="form-control" value="<%=request.getParameter("MessageTo")%>">
                                        </div>
                                        <div class="form-group">
                                            <input name="emailSubject" class="form-control" placeholder="Subject:" required>
                                        </div>
                                        <div class="form-group">
