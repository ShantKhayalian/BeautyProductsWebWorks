...
<head>
    ...
    <title>BP | User Admin</title>
        <!-- Script source for upload -->
        <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
        <link href="<%=request.getContextPath()%>/dist/dropzone.css" rel="stylesheet">
    <!-- Font awesome -->
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    ...
                                    <div class="body">
                                        <form action="AddLogo?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>" id="frmFileUpload" class="dropzone" method="post" enctype="multipart/form-data">
...
D:\bepr\src\main\webapp\WEB-INF\forUpload
<!-- Dropzone Plugin Js -->
<script src="<%=request.getContextPath()%>/forUpload/dropzone.js"></script>
