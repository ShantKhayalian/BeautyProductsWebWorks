                                            ...
                                            <div class="box-body table-responsive no-padding">
                                                <table class="table table-hover">
                                                    ...
                                                    <c:if test="${requestScope.addressBoxList != null}">
                                                        <c:forEach items="${requestScope.addressBoxList}" var="AddressBookList" varStatus="session">
                                                    <tr>
                                                        <td><c:out value="${AddressBookList.addedName}"/></td>
                                                        <td><c:out value="${AddressBookList.addedLastName}"/></td>
                                                        <td><a href="ReplayMessages?MessageFrom=<%=request.getAttribute("userEmail")%>&MessageTo=${AddressBookList.addedName}&Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><span class="label label-primary">Write message</span></a></td>
                                                    </tr>
                                                        </c:forEach>
                                                    </c:if>
                                                </table>
