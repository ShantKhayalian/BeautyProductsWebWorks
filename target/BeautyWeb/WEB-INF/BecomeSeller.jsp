            ...
            <div class="col-lg-9 col-md-9 col-sm-8 col-md-push-3">
                <div class="aa-product-catg-content">
                    ...
                    <div class="aa-product-catg-body">
                            ...
                            <br/>
                            <p class="text-justify">You are going to open your selling account.</p>
                            <a href="OpenSellerMarket?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>" type="button" class="btn btn-success">Please open my seller account.</a>
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-md-pull-9">
                <aside class="aa-sidebar">
                    ...
                    <div class="aa-sidebar-widget">
                        ...
                        <h3><fmt:message key="Sellers Section" bundle="${BundleContent}"/>
                            <br>
                        </h3>
