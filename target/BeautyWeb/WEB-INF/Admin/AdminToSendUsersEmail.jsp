                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <c:forEach items="${requestScope.usersList}" var="emailUsersList" varStatus="loop">
                                    <tr>

                                        <td><c:out value="${emailUsersList.userWebId}"/></td>
                                        <td><c:out value="${emailUsersList.userFirstName}"/>
                                        </td>
                                        <td><c:out value="${emailUsersList.userCountry}"/></td>
                                        <td><c:out value="${emailUsersList.userEmail}"/></td>

                                        <td><c:out value="${emailUsersList.isUserSeller}"/></td>

                                        <td>
                                            <a href="AdminCompose?userWebId=${emailUsersList.userWebId}&userEmail=${emailUsersList.userEmail}&senderEmail=info@beautyproducts.am" type="button" class="btn btn-danger btn-xs">Email</a>
                                        </td>
                                    </tr>
                                    </c:forEach>
                                    </c:if>
