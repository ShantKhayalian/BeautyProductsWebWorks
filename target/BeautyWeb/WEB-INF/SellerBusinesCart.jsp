                ...
                <div class="aa-product-catg-content">
                    ...
                    <div class="aa-product-catg-body">
                        <div class="containercart">
                            ...
                            <h2 style="text-align:center">Brand Business Card</h2>
                            <c:if test="${requestScope.brandsList != null}">
                                <c:forEach items="${requestScope.brandsList}" var="brand" varStatus="page">
                                    <div class="card">
                                        <img src="<c:out value="${brand.logo}"/>" alt="${brand.brandName}"
                                             style="width:100%">
                                        <h1>${brand.brandName}</h1>
                                        <p class="title">${brand.brandCategory}</p>
                                        <p>${brand.brandCity} - ${brand.brandCountry}</p><br>
                                            ${brand.brandKind} <br>
                                            ${brand.brandCreatedDate}
                                        <h1>Verifications</h1>
                                        <c:set value="${brand.isBrandAddressVerified}" var="YES"/>
                                        <c:choose>
                                            <c:when test="${YES == 'true'}">
                                                <p>Brand Address - yes </p>
                                            </c:when>
                                            <c:otherwise>
                                                <p>Brand Address - No </p>
                                            </c:otherwise>
                                        </c:choose>
                                        <c:set value="${brand.isBrandPhoneNumberVerified}" var="YES"/>
                                        <c:choose>
                                            <c:when test="${YES == 'true'}">
                                                <p>Brand Phone Number - yes </p>
                                            </c:when>
                                            <c:otherwise>
                                                <p>Brand Phone Number - No </p>
                                            </c:otherwise>
                                        </c:choose>
                                        <c:set value="${brand.isBrandHasCertifications}" var="YES"/>
                                        <c:choose>
                                            <c:when test="${YES == 'true'}">
                                                <p>Brand Certifications awards - yes </p>
                                            </c:when>
                                            <c:otherwise>
                                                <p>Brand Certifications awards - No </p>
                                            </c:otherwise>
                                        </c:choose>
                ...
                <aside class="aa-sidebar">
                    ...
                    <div class="aa-sidebar-widget">
                        ...
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                <li>
                                    <a href="SellerAddBrand?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>">
                                        <fmt:message key="Add Profile" bundle="${BundleContent}"/>
                                        <i class="fa fa-wrench"></i></a></li>

                                <li>
                                    <a href="SellerLogoBrand?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>">
                                        <fmt:message key="Logo" bundle="${BundleContent}"/>
                                        <i class="fa fa-unlock-alt"></i></a></li>

                                <li>
                                    <a href="AddBrandSocials?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>">
                                        <fmt:message key="Brand Social media" bundle="${BundleContent}"/>
                                        <i class="fa fa-unlock-alt"></i></a></li>

                                <li>
                                    <a href="ShowBusinessCart?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>">
                                        <fmt:message key="Business Cart" bundle="${BundleContent}"/>
                                        <i class="fa fa-unlock-alt"></i></a></li>

                                <li>
                                    <a href="SellerAdvertiseBrand?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>">
