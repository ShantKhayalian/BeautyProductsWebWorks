        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-8 col-md-push-3">
                <div class="aa-product-catg-content">
                    ...
                    <form action="AddSocialMediaForSeller" method="get">
                        <div class="aa-product-catg-body">
                            ...
                            <label> <span class="fa fa-twitter-square"></span> Twitter </label>
                            ...
                            <label> <span class="fa fa-linkedin-square"></span> linkedin </label>
                            <input name="linkedin" type="text" class="form-control"

                                   placeholder="Enter your linkedin link"
                                   value="" >

                            <label> <span class="fa fa-youtube-square"></span> Youtube </label>
                            ...
                            <label> <span class="fa fa-pinterest"></span> Pinterest </label>
                            <input name="pinterest" type="text" class="form-control"

                                   placeholder="Enter your pinterest link"
                                   value="" >

                            <label> <span class="fa fa-instagram"></span> Instagram </label>
                    ...
                    <div class="aa-sidebar-widget">
                        ...
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                ...
                                <li>
                                    <a href="SellerAddBrandSocials?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>">
