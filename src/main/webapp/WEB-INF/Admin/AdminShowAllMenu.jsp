                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                <c:if test="${requestScope.menuAllList != null}">
                                    <c:forEach items="${requestScope.menuAllList}" var="menuList" varStatus="loop">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <c:out value="${menuList.menuWebID}"/>
                                            </td>

                                            <td>
                                                <c:out value="${menuList.menuDefualtName}"/>

                                            <td>
                                                <c:out value="${menuList.menuArmenianName}"/>
                                            </td>

                                            <td>
                                                <c:out value="${menuList.menuArabicName}"/>
                                            </td>

                                            <td>
                                                <c:out value="${menuList.menuRussianName}"/>
                                            </td>

                                            <td>
                                                <c:out value="${menuList.menuFrenchName}"/>
                                            </td>
                                            <td>
                                                <form action="UpdateAdminMenu" method="get">
                                                <button type="submit" class="btn btn-block btn-success btn-sm">Update
                                                </button>
                                                <input type="hidden" name="MenuId"
                                                       value="<c:out value="${menuList.menuID}"/>">
                                                </form>
                                            </td>
                                            <td>
                                                <form action="RemoveAdminMenu" method="get">
