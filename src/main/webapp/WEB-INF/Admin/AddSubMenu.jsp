                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Quick Add Menu</h3>
                        </div>
                        <%
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="AddSubMenus" method="get">
                            <div class="box-body">
                                <select name="MenuId" class="form-control select2" style="width: 100%;">

                                    <c:forEach items="${requestScope.menuList}" var="menuListToChoose" >
                                    <option value="<c:out value="${menuListToChoose.menuWebID}"/>" selected="selected"><c:out value="${menuListToChoose.menuDefualtName}"/></option>

                                    </c:forEach>
                                    <input type="hidden" name="MenuId" value="${menuListToChoose.menuWebID}"/>

                                </select>

                                <div class="form-group">
                                    <label for="exampleInputMenu">Sub Menu </label>
                                    <input type="text" name="EnglishSubMenu" class="form-control" id="exampleInputMenu"
                                           placeholder="English sub menu" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputMenuArmenian">Armenian Sub menu</label>
                                    <input type="text" name="ArmenianSubMenu" class="form-control"
                                           id="exampleInputMenuArmenian" placeholder="Armenian sub menu" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputMenuArabic">Arabic Sub menu</label>
                                    <input type="text" name="ArabicSubMenu" class="form-control"
                                           id="exampleInputMenuArabic" placeholder="Arabic sub menu" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputMenuRussian">Russian Sub menu</label>
                                    <input type="text" name="RussianSubMenu" class="form-control"
                                           id="exampleInputMenuRussian" placeholder="Russian sub menu" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputMenuFrench">French Sub menu</label>
                                    <input type="text" name="FrenchSubMenu" class="form-control"
