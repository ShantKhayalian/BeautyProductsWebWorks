				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="box box-primary">
							...
							<!-- /.box-header -->
							<!-- form start -->
							<form role="form" action="UpdateMenuById" method="post">
								<div class="box-body">
									<c:if test="${requestScope.menuListById != null}">
										<c:forEach items="${requestScope.menuListById}" var="menu" varStatus="page">
											Menu id = ${menu.menuID} | Menu Web id = ${menu.menuWebID}
									<div class="form-group">
										<label for="exampleInputMenu">Menu </label>
										<input type="text" value="${menu.menuDefualtName}" name="EnglishMenu" class="form-control" id="exampleInputMenu" placeholder="Menu" required>
									</div>
									<div class="form-group">
										<label for="exampleInputMenuArmenian">Armenian menu</label>
										<input type="text" value="${menu.menuArmenianName}" name="ArmenianMenu" class="form-control" id="exampleInputMenuArmenian" placeholder="Armenian menu" required>
									</div>
									<div class="form-group">
										<label for="exampleInputMenuArabic">Arabic menu</label>
										<input type="text" value="${menu.menuArabicName}" name="ArabicMenu" class="form-control" id="exampleInputMenuArabic" placeholder="Arabic menu" required>
									</div>
									<div class="form-group">
										<label for="exampleInputMenuRussian">Russian menu</label>
										<input type="text" value="${menu.menuRussianName}" name="RussianMenu" class="form-control" id="exampleInputMenuRussian" placeholder="Russian menu" required>
									</div>
									<div class="form-group">
										<label for="exampleInputMenuFrench">French menu</label>
										<input type="text" value="${menu.menuFrenchName}" name="FrenchMenu" class="form-control"  id="exampleInputMenuFrench" placeholder="French menu" required>
									</div>
