							...
							<div class="box-body no-padding">
								...
								<div class="table-responsive mailbox-messages">
									<table class="table table-hover table-striped">
										<tbody>
										<c:if test="${requestScope.spyEmail != null}">
											<c:forEach items="${requestScope.spyEmail}" var="spiedEmails" varStatus="loop">
										<tr>


											<td class="mailbox-name"><c:out value="${spiedEmails.messageID}"/></td>
											<td class="mailbox-name"><c:out value="${spiedEmails.messageFrom}"/></td>
											<td class="mailbox-name"><a href="CheckProfile?Profile=${spiedEmails.messageFrom}"><c:out value="${spiedEmails.messageTo}"/></td>
											<td class="mailbox-subject"><a href="ReadAdminFromInbox?EmailId=${spiedEmails.messageID}"><b><c:out value="${spiedEmails.messageTitle}" /></b></a>

											</td>
											<td class="mailbox-attachment"></td>
											<td class="mailbox-date"><c:out value="${spiedEmails.messageDate}" /></td>
										</tr>
											</c:forEach>
										</c:if>
										</tbody>
