        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview"><a href="#"> <i class="fa fa-user"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="AdminAddSubMenu"><i
                                class="fa fa-wrench"></i>
                            Add Sub menu
                            <span class="pull-right-container"> <small
                                    class="fa fa-circle-o text-red"></small>
								</span> </a></li>
                        <li><a href="AdminShowAllSubMenu"><i
                                class="fa fa-unlock-alt"></i>
                            Sub Menu List
                        </a></li>
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Quick Update Sub Menu</h3>
                        </div>
                        <%
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="UpdateSubMenuById" method="get">
                            <div class="box-body">
                                <c:if test="${requestScope.subMenuListById!=null}">
                                    <c:forEach items="${requestScope.subMenuListById}" var="subMenuById" varStatus="page">
                                <div class="form-group">
                                    <label >Under Menu </label>
                                   <h3>${subMenuById.menuname} | ${subMenuById.menuId}</h3>
                                    <input type="hidden" name="MenuName" value="${subMenuById.menuname}">
                                    <input type="hidden" name="MenuId" value="${subMenuById.menuId}">
                                    <input type="hidden" name="subMenuWebId" value="${subMenuById.subMenuWebId}">
                                    <input type="hidden" name="subMenuId" value="${subMenuById.subMenuId}">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputMenu">Sub Menu </label>
                                    <input type="text" value="${subMenuById.subMenuDefualtName}" name="EnglishSubMenu" class="form-control" id="exampleInputMenu"
                                           placeholder="English Sub Menu" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputMenuArmenian">Armenian Sub menu</label>
                                    <input type="text" value="${subMenuById.subMenuArmenianName}" name="ArmenianSubMenu" class="form-control"
                                           id="exampleInputMenuArmenian" placeholder="Armenian Sub Menu" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputMenuArabic">Arabic Sub menu</label>
                                    <input type="text" value="${subMenuById.subMenuArabicName}" name="ArabicSubMenu" class="form-control"
                                           id="exampleInputMenuArabic" placeholder="Arabic Sub Menu" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputMenuRussian">Russian Sub menu</label>
                                    <input type="text" value="${subMenuById.subMenuRussianName}" name="RussianSubMenu" class="form-control"
                                           id="exampleInputMenuRussian" placeholder="Russian Sub Menu" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputMenuFrench">French Sub menu</label>
                                    <input type="text" value="${subMenuById.subMenuFrenchName}" name="FrenchSubMenu" class="form-control"
                                           id="exampleInputMenuFrench" placeholder="French Sub Menu" required>
                                </div>
                                    </c:forEach>
                                </c:if>
