...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<aside class="main-sidebar">
          ...
          <ul class="treeview-menu">
            <li class="active">
              <a href="mailbox.html"> <i class="fa  fa-inbox"></i>Inbox
                <span class="pull-right-container">
            ...
            <section class="content">
					...
					<div class="col-md-9">
						<div class="box box-primary">
							...
							<!-- /.box-header -->
							<form action="AdminSendEmail" method="post">
							<div class="box-body">
								<div class="form-group" >
									<input name="emailTo" value ="<%=request.getParameter("userEmail")%>" class="form-control" placeholder="To:" required>
                                    <input type="hidden" name="emailFrom" value="value ="<%=request.getParameter("senderEmail")%>" />
								</div>
								<div class="form-group">
