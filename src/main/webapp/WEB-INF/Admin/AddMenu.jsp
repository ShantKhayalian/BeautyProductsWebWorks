				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="box box-primary">
							...
							<!-- /.box-header -->
							<!-- form start -->
							<form role="form" action="AddMenus" method="get">
								<div class="box-body">
									<div class="form-group">
										<label for="exampleInputMenu">Menu </label>
										<input type="text" name="EnglishMenu" class="form-control" id="exampleInputMenu" placeholder="Menu" required>
									</div>
									<div class="form-group">
										<label for="exampleInputMenuArmenian">Armenian menu</label>
										<input type="text" name="ArmenianMenu" class="form-control" id="exampleInputMenuArmenian" placeholder="Armenian menu" required>
									</div>
									<div class="form-group">
										<label for="exampleInputMenuArabic">Arabic menu</label>
										<input type="text" name="ArabicMenu" class="form-control" id="exampleInputMenuArabic" placeholder="Arabic menu" required>
									</div>
									<div class="form-group">
										<label for="exampleInputMenuRussian">Russian menu</label>
										<input type="text" name="RussianMenu" class="form-control" id="exampleInputMenuRussian" placeholder="Russian menu" required>
									</div>
									<div class="form-group">
										<label for="exampleInputMenuFrench">French menu</label>
										<input type="text" name="FrenchMenu" class="form-control" id="exampleInputMenuFrench" placeholder="French menu" required>
									</div>
