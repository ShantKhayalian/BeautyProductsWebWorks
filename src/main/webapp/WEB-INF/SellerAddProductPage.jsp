...
<head>
    ...
    <title>BP | User Admin</title>
        ...
        <link href="<%=request.getContextPath()%>/assets/css/paper-bootstrap-wizard.css" rel="stylesheet" />
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-md-pull-9">
                <aside class="aa-sidebar">
                    ...
                    <div class="aa-sidebar-widget">
                        ...
                        <!-- $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ Products -->
                        <button class="accordion">
                            <fmt:message key="Products" bundle="${BundleContent}"/>
                            <i class="fa fa-user"></i></button>
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                <li>
                                    <a href="AddProductPage?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>">
                                        <fmt:message key="Add Product" bundle="${BundleContent}"/>
                                        <i class="fa fa-wrench"></i></a></li>
                        ...
                        <!-- $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ Products -->
                        <!--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////Shipping Start-->
                        <button class="accordion"><fmt:message key="Shipping " bundle="${BundleContent}"/> <i
                                class="fa fa-user"></i></button>
                        ...
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                <li>
                                    <a href="UserUpdateUserProfile?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message
                                            key="Add shipping" bundle="${BundleContent}"/> <i
                                            class="fa fa-wrench"></i></a></li>
                                <li>
                                    <a href="UserChangePassword?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message
                                            key="Change password" bundle="${BundleContent}"/> <i
