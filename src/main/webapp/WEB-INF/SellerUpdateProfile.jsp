                                            ...
                                            <div class="box-body">
                                                <div class="form-group">
                                                    ...
                                                    <c:if test="${requestScope.usersList != null}">
                                                        <c:forEach items="${requestScope.usersList}" var="userList"
                                                                   varStatus="Page">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${ON != 'null'}">
                                                                    <input name="FirstName" type="text"
                                                                           ...
                                                                           value="${userList.userFirstName}" required>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input name="FirstName" type="text"
                                                                           class="form-control"
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${ON != 'null'}">
                                                                    <input name="LastName" type="text"
                                                                           ...
                                                                           value="${userList.userLastName}" required>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input name="LastName" type="text"
                                                                           class="form-control"
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${ON != 'null'}">
                                                                    <input name="Address1" type="text"
                                                                           ...
                                                                           value="${userList.userAddress}" required>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input name="Address1" type="text"
                                                                           class="form-control"
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${ON != 'null'}">
                                                                    <select name="Country" class="form-control select2"
                                                                        ...
                                                                        <option value="${userList.userCountry}"
                                                                                selected="selected">${userList.userCountry}</option>
                                                                        ...
                                                                        <option value="BOL">Bolivia, Plurinational State
                                                                            of
                                                                        </option>
                                                                        <option value="BES">Bonaire, Sint Eustatius and
                                                                            Saba
                                                                        </option>
                                                                        ...
                                                                        <option value="VEN">Venezuela, Bolivarian
                                                                            Republic of
                                                                        </option>
                                                                ...
                                                                <c:otherwise>
                                                                    <select name="Country" class="form-control select2"
                                                                            style="width: 100%;" required>
                                                                        <option value="AFG" selected="selected">
                                                                            Afghanistan
                                                                        </option>
                                                                        <option value="ALA">Åland Islands</option>
                                                                        <option value="ALB">Albania</option>
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <c:set var="ON" value="${userList.userPhone}"/>
                                                                <c:choose>
                                                                    <c:when test="${ON != 'null'}">
                                    ...
                                    <ul class="aa-catg-nav">
                                        <li>
                                            <a href="ReadUserEmail?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message
                                                    key="Inbox" bundle="${BundleContent}"/> <i
