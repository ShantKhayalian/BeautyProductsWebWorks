                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <c:if test="${requestScope.usersList != null}">
                                                <c:forEach items="${requestScope.usersList}" var="userList" varStatus="Page">
                                                    <c:set var="ON" value="${userList.userFirstName}"/>
                                                    <c:choose>
                                                    <c:when test="${ON != 'null'}">

                                            <input name="FirstName" type="text" class="form-control" id="exampleInputFirstName"
                                                   placeholder="Enter your First Name" value="${userList.userFirstName}" required>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <input name="FirstName" type="text" class="form-control" id="exampleInputFirstName"
                                                    ...
                                                    <c:set var="ON" value="${userList.userLastName}"/>
                                                    <c:choose>
                                                    <c:when test="${ON != 'null'}">

                                            <input name="LastName" type="text" class="form-control" id="exampleInputLastName"
                                                   placeholder="Enter your Last Name" value="${userList.userLastName}" required>
                                                    </c:when>
                                                    <c:otherwise>
                                                    <input name="LastName" type="text" class="form-control" id="exampleInputLastName"
                                                    ...
                                                    <label for="exampleInputAddress1">Address one</label>
                                                    <c:set var="ON" value="${userList.userAddress}"/>
                                                    <c:choose>
                                                    <c:when test="${ON != 'null'}">

                                            <input name="Address1" type="text" class="form-control" id="exampleInputAddress1"
                                                   placeholder="Enter your Address" value="${userList.userAddress}"  required>
                                                    </c:when>
                                                    <c:otherwise>
                                                    <input name="Address1" type="text" class="form-control" id="exampleInputAddress1"
                                                           placeholder="Enter your Address" value="${userList.userAddress}"  required>
                                                    ...
                                                    <label for="exampleInputAddress2">Address two</label>
                                                    <c:set var="ON" value="${userList.userAddress2}"/>
                                                    <c:choose>
                                                    <c:when test="${ON != 'null'}">

                                            <input name="Address2" type="text" class="form-control" id="exampleInputAddress2"
                                                   placeholder="Enter your Address" value="${userList.userAddress2}">
                                                    </c:when>
                                                    <c:otherwise>
                                                        <input name="Address2" type="text" class="form-control" id="exampleInputAddress2"
                                            ...
                                            <label>Country</label>
                                                    <c:set var="ON" value="${userList.userCountry}"/>
                                                    <c:choose>
                                                    <c:when test="${ON != 'null'}">
                                            <select  name="Country" class="form-control select2" style="width: 100%;" required >
                                                <option value="${userList.userCountry}" selected="selected" >${userList.userCountry}</option>
                                            ...
                                            <label for="exampleInputCity">City</label>
                                                    <c:set var="ON" value="${userList.userCity}"/>
                                                    <c:choose>
                                                    <c:when test="${ON != 'null'}">

                                            <input name="City" type="text" class="form-control" id="exampleInputCity"
                                                   placeholder="City" required value="${userList.userCity}" >
                                                    </c:when>
                                                    <c:otherwise>
                                                    <input name="City" type="text" class="form-control" id="exampleInputCity"
                                            ...
                                            <label for="exampleInputZip">ZipCode</label>
                                                    <c:set var="ON" value="${userList.userZip}"/>
                                                    <c:choose>
                                                    <c:when test="${ON != 'null'}">
                                            <input name="ZipCode" type="text" class="form-control" id="exampleInputZip"
                                                   placeholder="ZipCode" required value="${userList.userZip}">
                                                    </c:when>
                                                    <c:otherwise>
                                                    <input name="ZipCode" type="text" class="form-control" id="exampleInputZip"
                                            ...
                                            <label for="exampleInputState">State</label>
                                                    <c:set var="ON" value="${userList.userState}"/>
                                                    <c:choose>
                                                    <c:when test="${ON != 'null'}">
                                            <input name="State" type="text" class="form-control" id="exampleInputState"
                                                   placeholder="State" required value="${userList.userState}">
                                                    </c:when>
                                                    <c:otherwise>
                                                    <input name="State" type="text" class="form-control" id="exampleInputState"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="PhoneNumber" type="number" class="form-control"
                                                       data-inputmask='"mask": "(999) 999-9999"' data-mask required value="${userList.userPhone}">
                                                </c:when>
                                                <c:otherwise>
                                                <input name="PhoneNumber" type="number" class="form-control"
                    ...
                    <div class="aa-sidebar-widget">
                        ...
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                ...
                                <li>
                                    <a href="SellerAddressVer?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message
                                            key="Address verification" bundle="${BundleContent}"/> <i
                        ...
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                <li>
                                    <a href="UserWishList?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message
                                            key="Wish list" bundle="${BundleContent}"/> <i
                                            class="fa fa-heart"></i></a></li>
                                <li>
                                    <a href="UserLovedProductList?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>">
                                        <fmt:message key="Products" bundle="${BundleContent}"/> <i
                                            class="fa fa-anchor"></i></a></li>
                                <li>
                                    <a href="UserLovedBrandList?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message
                                            key="Brand" bundle="${BundleContent}"/> <i
                                            class="fa fa-diamond"></i></a></li>
                                <li>
                                    <a href="UserLovedSellerList?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message
                                            key="Sellers" bundle="${BundleContent}"/> <i
                                            class="fa fa-diamond"></i></a></li>
                        ...
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                <li>
                                    <a href="UserSendGiftCard?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message
                                            key="send Gift cards" bundle="${BundleContent}"/> <i
                                            class="fa fa-gift"></i></a></li>
                                <li>
                                    <a href="UserRecievedGiftCard?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message
                                            key="recieved Gift cards" bundle="${BundleContent}"/> <i
                                            class="fa fa-gift"></i></a></li>
                            </ul>
                        </div>
                        ...
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                <li>
                                    <a href="BecomeSeller?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>">
                                        <fmt:message key="Become seller" bundle="${BundleContent}"/> <i
