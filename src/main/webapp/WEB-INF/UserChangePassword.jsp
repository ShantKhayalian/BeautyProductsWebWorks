                    ...
                    <div class="aa-product-catg-body">
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <!--UserWebId int(11)
                               -->
                                <form  action="UserCheckChangePassword" method="post">
                                    <div class="box-body">
                                        <%
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="txtConfirmPassword">Old Password</label>
                                            <input name="OldPassword" type="password" class="form-control"
                                                   placeholder="Old password" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required id="txtPassword">
                                        </div>
                                        <script>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="txtConfirmPassword">Compare Password</label>
                                            <input name="CompareOldPassword" type="password" class="form-control" id="txtConfirmPassword"
                                                   placeholder="compare old password" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <button type="submit" onclick="return Validate()" class="btn btn-block btn-primary btn-flat">
                                                Change Password
                                            </button>
                                            <script type="text/javascript">
                                                function Validate() {
                    ...
                    <div class="aa-sidebar-widget">
                        ...
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                ...
                                <li><a href="SellerAddressVer?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message key="Address verification" bundle="${BundleContent}"/> <i
                        ...
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                <li><a href="UserWishList?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message key="Wish list" bundle="${BundleContent}"/> <i
                                        class="fa fa-heart"></i></a></li>
                                <li><a href="UserLovedProductList?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"> <fmt:message key="Products" bundle="${BundleContent}"/> <i
                                        class="fa fa-anchor"></i></a></li>
                                <li><a href="UserLovedBrandList?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message key="Brand" bundle="${BundleContent}"/> <i
                                        class="fa fa-diamond"></i></a></li>
                                <li><a href="UserLovedSellerList?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message key="Sellers" bundle="${BundleContent}"/> <i
                                        class="fa fa-diamond"></i></a></li>
                        ...
                        <div class="panel">
                            <ul class="aa-catg-nav">
                                <li><a href="UserSendGiftCard?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message key="send Gift cards" bundle="${BundleContent}"/> <i
                                        class="fa fa-gift"></i></a></li>
                                <li><a href="UserRecievedGiftCard?Pagelanguage=${Pagelanguage}&PageCurrency=<%= request.getAttribute("PageCurrency")%>"><fmt:message key="recieved Gift cards" bundle="${BundleContent}"/> <i
                                        class="fa fa-gift"></i></a></li>
                                                </ul>
                        </div>
