...
public class UserUpdateProfile extends HttpServlet {
    ...
    private String PhoneNumberConverter = null;
    private int updateUserChecker = 0;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            userUpdateProfile(request, response);
    ...
    private void userUpdateProfile(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
        getSession(request);
    ...
    private void updateUserInfo(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        Users users = new Users(userEmail, FirstName, LastName, City, State, ZipCode, PhoneNumberConverter, Country, Address1, Address2);
        updateUserChecker = usersDao.UpdateUserInfo(users, userWebId);
        if (updateUserChecker == 0) {
            String message = "Something went wrong Please try again";
            gotoPage(request, response, message);
        } else {
            String message = "You successfully Update your Profile";
            gotoPage(request, response, message);
        }
    }
    ...
    private void getSession(HttpServletRequest request) {
        ...
        System.out.println("userEmail in Session UserUpdateProfile " + userEmail);
    }
