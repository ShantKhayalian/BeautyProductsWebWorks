...
public class BecomeSeller extends HttpServlet {
    ...
    private void becomeSeller(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
        getSession(request);
    ...
    private void gotoPage(HttpServletRequest request, HttpServletResponse response,String message) throws
        ...
        request.getRequestDispatcher("WEB-INF/BecomeSeller.jsp").forward(request, response);
    }
